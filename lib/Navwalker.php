...
if ( !class_exists( 'Navwalker' ) ):
    ...
    class Navwalker extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
            ...
            if(!empty(carbon_get_nav_menu_item_meta($item->ID, 'mega_menu_template'))){
                $class_names .= ' mega-menu-toggle';
            }
            ...
            if(!empty(carbon_get_nav_menu_item_meta($item->ID, 'icon'))){
              $output .= wp_get_attachment_image(carbon_get_nav_menu_item_meta($item->ID, 'icon'), 'original');                
            }
        ...
        public function end_el( &$output, $data_object, $depth = 0, $args = null ) {
            ...
            if(!empty(carbon_get_nav_menu_item_meta($data_object->ID, 'mega_menu_template'))){
                ob_start();

                include QTWP_VIEW . '/mega-menus/' . carbon_get_nav_menu_item_meta($data_object->ID, 'mega_menu_template') . '.php'; 
                $output .= ob_get_clean();
            }
        ...
        public function mega_menu( &$output, $item, $depth = 0, $args = null, $id = 0){
            if ( isset( $args->item_spacing ) && 'discard' === $args->item_spacing ) {
                $t = '';
                $n = '';
            } else {
